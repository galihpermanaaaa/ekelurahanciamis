...
<div class="card">
  <div class="card-body pt-3">
    ...
    <ul class="nav nav-tabs nav-tabs-bordered">
      ...
      <li class="nav-item">
       <h3>Surat Pelaporan Keterangan Kematian</h3>
      </li>
    </ul>
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    @if($item->verifikasi =='Belum Diverifikasi')
                      ...
                      <a href="{{ url('layanan/surat_kematian/'.$item->id) }}" target="_blank" class="btn btn-primary btn-sm" style="font-size: 14px; color: white" ></i> Silahkan Download</a>
