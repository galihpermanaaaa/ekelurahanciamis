       ...
       <h3>Surat Keterangan Duda</h3>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <h5 class="card-title">Berikut hasil Pembuatan Surat Anda</h5>
                  ...
                  <div class="row">
                    ...
                    @if($item->verifikasi =='Belum Diverifikasi')
                      ...
                      <a href="{{ url('layanan/surat_duda/'.$item->id) }}" target="_blank" class="btn btn-primary btn-sm" style="font-size: 14px; color: white" ></i> Silahkan Download</a>
