...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Data Keluarga Berencana Masyarakat Kelurahan Ciamis</h1>
    </div><!-- End Page Title -->
...
<br>
    ...
    <div class="search-bar col-md-4">
      <form class="search-form d-flex align-items-center" method="GET" action="{{ route('user/profile_kelurahan/data_kb/cari_kb') }}">
      <select  class="form-control @error('berencana') is-invalid @enderror" name="berencana" id="berencana" required>
                        <option value="">--Pilih Jenis KB--</option>
                        <option value="PUS">PUS</option>
                        <option value="Peserta KB Aktif">Peserta KB Aktif</option>
                        <option value="Pra KS">Pra KS</option>
        ...
        <a href="{{ route('user/profile_kelurahan/data_kb') }}" class="btn btn-success btn-sm">Refresh</a>
      </form>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title">Daftar Keluarga Berencana Masyarakat Kelurahan Ciamis</h5>
  ...
  @include('layouts.footer')
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                            <h5 class="modal-title">Edit Data Keluarga Berencana Masyarakat Kelurahan Ciamis</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        <form action="{{ route('update_kb') }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <div id="hapus_umur" class="modal custom-modal fade" role="dialog">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                            <h5 class="modal-title">Hapus Data Keluarga Berencana Masyarakat Kelurahan Ciamis Tersebut</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        <form action="{{ route('hapus_kb') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('DELETE')}}
                        <div class="container col-md-12">
                        <div class="row">
                    ...
                    <div class="col-md-12">
                        <label class="form-label">Jenis KB</label>
                        <input type="hidden" name="id" id="id">
                        <input type="text" class="form-control @error('berencana') is-invalid @enderror" id="berencana" name="berencana" required readonly />
                        </select>
                        @error('berencana')
                        <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalkdp">Input Data Keluarga Berencana Masyarakat Kelurahan Ciamis</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            <form action="{{ route('save_kb') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    <div class="container col-md-12">
                    <div class="row">
...
var Berencana = button.data('berencana') 
var Jumlah = button.data('jumlah') 

var modal = $(this)
modal.find('.modal-body #id').val(ID)
modal.find('.modal-body #berencana').val(Berencana)
