        ...
        <div class="col-xl-6">
          ...
          <form action="" method="POST" enctype="multipart/form-data">
             @csrf
              <div class="row gy-4">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" value="{{ $data[0]->disebabkan}}" required readonly>
                  </div>

                  <div class="col-md-6">
                  <label>Tempat Meninggal</label>
                  <input type="text" class="form-control" value="{{ $data[0]->ditempat}}" required readonly>
                  </div>
            ...
            <br>
                ...
                <a href="{{ route('user/kematian/data_kematian') }}" class="btn btn-danger btn-sm">Kembali</a>
                </div>
