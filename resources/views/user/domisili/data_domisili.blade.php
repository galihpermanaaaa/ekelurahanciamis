...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Daftar Surat Keterangan Domisili</h1>
    </div><!-- End Page Title -->
...
<br>
    ...
    <div class="search-bar col-md-3">
      <form class="search-form d-flex align-items-center" method="GET" action="{{ route('user/domisili/data_domisili/cari_domisili') }}">
      <select class="form-control" name="id_rw" id="id_rw" required>
        ...
        <a href="{{ route('user/domisili/data_domisili') }}" class="btn btn-success btn-sm">Refresh</a>
      </form>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Daftar Pembuat SKD</h5>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <a href="{{ url('user/domisili/verifikasi_domisili/'.$item->id) }}" class="btn btn-primary btn-sm" style="font-size: 14px; color: white" ></i> Verifikasi</a>	
                    ...
                    <td> 
                      ...
                      @elseif($item->verifikasi =='Terverifikasi')
                      <a href="{{ url('user/domisili/lihat_data_domisili/'.$item->id) }}" class="btn btn-info" style="font-size: 14px; color: white" ></i> Lihat Data</a>	
                      @else($item->verifikasi =='Ditolak')
                      <a href="{{ url('user/domisili/lihat_data_domisili/'.$item->id) }}" class="btn btn-info" style="font-size: 14px; color: white" ></i> Lihat Data</a>
                      @endif
              ...
              <span class="badge bg-success">Jumlah Surat Domisili Terverifikasi: {{$count_terverifikasi}}</span><br>
              <span class="badge bg-danger">Jumlah Surat Domisili Ditolak: {{$count_ditolak}}</span>
            </div>
          </div>
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                            <h5 class="modal-title">Hapus Pembuat Surat Keterangan Domisili</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        <form action="{{ route('delete_domisili') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('DELETE')}}
