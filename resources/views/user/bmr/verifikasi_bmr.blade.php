...
@include('user.bmr.image')

<main id="main" class="main">

    <div class="pagetitle">
      <h1>Verifikasi Pembuatan Surat Keterangan Belum Memiliki Rumah</h1>
      <nav>
    ...
    <section class="section contact">
      ...
      <div class="row gy-4">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <p>
                <img id="myImg" src="{{ URL::to('/bmr/ktp/'. $data[0]->ktp) }}" alt="" width="20%" height="30%">
            ...
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <p><img id="myImg2" src="{{ URL::to('/bmr/kk/'. $data[0]->kk) }}" alt="" width="20%" height="30%">
										<P style="color:red;">(Klik Gambar Untuk Memperbesar)</p>
            ...
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <p><img id="myImg3" src="{{ URL::to('/bmr/pengantar_rt_rw/'. $data[0]->surat_pengantar_rt) }}" alt="" width="20%" height="30%">
										<P style="color:red;">(Klik Gambar Untuk Memperbesar)</p>
            ...
            <div class="col-lg-6">
              <div class="info-box card">
                <i class="bi bi-wallet"></i>
                <h3>Surat Pernyataan Bermaterai</h3>
                <p><img id="myImg4" src="{{ URL::to('/bmr/surat_pernyataan_bermaterai/'. $data[0]->surat_pernyataan_bermaterai) }}" alt="" width="20%" height="30%">
										<P style="color:red;">(Klik Gambar Untuk Memperbesar)</p>
        ...
        <div class="col-xl-6">
          <div class="card p-4">
          <form action="{{ route('verifikasi_bmr_bmr') }}" method="POST" enctype="multipart/form-data">
             @csrf
              <div class="row gy-4">
                ...
                <div class="col-md-6">
                  <label>Pengantar Dari RT</label>
                  <input type="number" class="form-control" value="{{$data[0]->pengantar_dari_rt}}" required readonly>
                </div>

                <div class="col-md-6">
                  <label>Pengantar Dari RW</label>
                  <input type="number" class="form-control" value="{{$data[0]->pengantar_dari_rw}}" required readonly>
                </div>
