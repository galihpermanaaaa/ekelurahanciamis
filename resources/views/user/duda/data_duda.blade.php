        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <span class="badge bg-success">Jumlah Surat Keterangan Duda Terverifikasi: {{$count_terverifikasi}}</span><br>
              <span class="badge bg-danger">Jumlah Surat Keterangan Duda Ditolak: {{$count_ditolak}}</span>
