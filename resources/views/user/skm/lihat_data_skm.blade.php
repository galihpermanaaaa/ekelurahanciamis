...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Lihat Data Pembuat Surat keterangan Tidak Mampu</h1>
      <nav>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <p><img id="myImg" src="{{ URL::to('/skm/kk_skm/'. $data[0]->kk) }}" alt="" width="20%" height="30%">
            ...
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <p><img id="myImg2" src="{{ URL::to('/skm/surat_pengantar_rt_rw_skm/'. $data[0]->surat_pengantar_rt_rw) }}" alt="" width="20%" height="30%">
										<P style="color:red;">(Klik Gambar Untuk Memperbesar)</p>
            ...
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <p><img id="myImg3" src="{{ URL::to('/skm/surat_pernyataan_miskin_skm/'. $data[0]->surat_pernyataan_miskin) }}" alt="" width="20%" height="30%">
										<P style="color:red;">(Klik Gambar Untuk Memperbesar)</p>
        ...
        <div class="col-xl-6">
          ...
          <form action="" method="POST" enctype="multipart/form-data">
             @csrf
              <div class="row gy-4">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" value="{{$data[0]->untuk_persyaratan}}" required readonly>
                </div>

                <div class="col-md-6">
                  <label>Tanggal Diverifikasi</label>
                  <input type="text" class="form-control" value="{{ tanggal_indonesia($data[0]->tanggal_verifikasi)}}" readonly />
                </div>

                <div class="col-md-12">
                    <label>Status Verifikasi</label>
                    <input type="text" class="form-control" value="{{$data[0]->verifikasi}}" required readonly>
                </div>
            ...
            <br>
                ...
                <a href="{{ route('user/skm/data_skm') }}" class="btn btn-danger btn-sm">Kembali</a>
                </div>
