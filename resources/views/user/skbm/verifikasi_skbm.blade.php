...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Verifikasi Pembuatan Surat Keterangan Belum Menikah</h1>
      <nav>
    ...
    <section class="section contact">
      ...
      <div class="row gy-4">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <p>
                <img id="myImg" src="{{ URL::to('/suratbelummenikah/ktp/'. $data[0]->ktp) }}" alt="" width="20%" height="30%">
            ...
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <p><img id="myImg2" src="{{ URL::to('/suratbelummenikah/kk/'. $data[0]->kk) }}" alt="" width="20%" height="30%">
										<P style="color:red;">(Klik Gambar Untuk Memperbesar)</p>
            ...
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <p><img id="myImg3" src="{{ URL::to('/suratbelummenikah/pengantar_rt_rw/'. $data[0]->surat_pengantar_rt) }}" alt="" width="20%" height="30%">
										<P style="color:red;">(Klik Gambar Untuk Memperbesar)</p>
        ...
        <div class="col-xl-6">
          <div class="card p-4">
          <form action="{{ route('verifikasi_skbm_skbm') }}" method="POST" enctype="multipart/form-data">
             @csrf
              <div class="row gy-4">
