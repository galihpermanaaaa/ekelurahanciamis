...
<main id="main" class="main">
    ...
    <h1>Daftar Surat Keterangan Janda RW : {{$items->nama_rw}}</h1>
    @endforeach
    </div><!-- End Page Title -->
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td>{{$item->nama}}</td>
                      <td>{{$item->email}}</td>
                <td>  <a href="{{ url('user/janda/lihat_data_janda/'.$item->id) }}" class="btn btn-info" style="font-size: 14px; color: white" ></i> Lihat Data</a>	
                   </td>
