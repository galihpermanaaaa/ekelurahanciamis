...
@include('user.janda.image')

<main id="main" class="main">

    <div class="pagetitle">
      <h1>Verifikasi Pembuatan Surat Keterangan Janda</h1>
      <nav>
    ...
    <section class="section contact">
      ...
      <div class="row gy-4">
        ...
        <div class="col-xl-6">
          <div class="card p-4">
          <form action="{{ route('verifikasi_janda_janda') }}" method="POST" enctype="multipart/form-data">
             @csrf
              <div class="row gy-4">
                ...
                <div class="col-md-6">
                  <label>Surat Pengantar Dari</label>
                  <input type="text" class="form-control" value="{{ $data[0]->pengantar_dari}}" required readonly>
                </div>

                <div class="col-md-6">
                  <label>Melengkapi</label>
