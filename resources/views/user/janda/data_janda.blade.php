        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <span class="badge bg-success">Jumlah Surat Keterangan Janda Terverifikasi: {{$count_terverifikasi}}</span><br>
              <span class="badge bg-danger">Jumlah Surat  Keterangan Janda Ditolak: {{$count_ditolak}}</span>
