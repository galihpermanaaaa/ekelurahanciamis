           ...
           <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control @error('tanggal_kematian') is-invalid @enderror" id="tanggal_kematian" name="tanggal_kematian" placeholder="tanggal Kematian" required />
