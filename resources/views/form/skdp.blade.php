<!-- Modal Domisili Menu -->
<div class="modal fade" id="modalkdp_menu" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalkdp" aria-hidden="true">
 ...
 <div class="d-grid gap-2">
    ...
    <!-- Modal Janda Menu -->
     <!-- Modal Janda Cek -->
  <div class="modal fade" id="modalkdp_cek" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalkdp" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalkdp">Surat Keterangan Domisili Perusahaan</h5>
    ...
    <!-- Modal Janda Cek -->
  <!-- Modal Janda Buat -->
<div class="modal fade" id="modalkdp_buat" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalkdp" aria-hidden="true">
